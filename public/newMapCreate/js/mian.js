...
function foggyCheck(flag){
    if(flag){
        document.form1.c1[1].checked = false;
//        data.foggy = true;
//        console.log("t",data.foggy);
    }
    else{
        document.form1.c1[0].checked = false;
//        data.foggy = false;
//        console.log("f",data.foggy);
    }
}